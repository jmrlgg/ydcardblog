...
<section class="section extra-margins listing-section justify-content-center">
  ...
  <!-- {% block header %} -->
   <header class="row mb-5">
      <div itemprop="liveBlogUpdate" itemscope itemtype="http://schema.org/BlogPosting" class="col-md-12">
      <?php 
      if ( has_post_thumbnail() ) : // check if the post has a Post Thumbnail assigned to it.
        ?>
          <div itemprop="image" class="head" style="opacity: 0.8;background-color: rgba(0,0,0,0.5); background-image: url('<?php echo the_post_thumbnail_url('large'); ?>');background-repeat: no-repeat;background-size: cover; ">
          <?php endif ?>
              <div class="text-center rgba-stylish-strong py-5 px-4">
                  <div class="py-5">
                  

                          <h1 itemprop="headline" id="header-title" style="font-weight:700;font-size:4em;" class="pt-3 mb-5 text-white header-title post-heading"><?php the_title(); ?></h1>
                          <h2 itemprop="keywords" style="font-weight:500;font-size:1.5em;" class="px-5 pb-4 text-white subheading"><?php the_tags( '<button type="button" class="btn btn-lg btn-info">', ' </button> <button type="button" class="btn btn-lg btn-info">', '</button>' ); ?>
</h2>
                          <p id="meta" class="date meta">Posted by:
                                  <a class="meta date" itemprop="creator" href="#"><?php the_author(); ?></a>
                                    <br>
                                      on <?php the_date(); ?>
          ...
          <div class="head" style="opacity: 0.8;background-color: rgba(0,0,0,0.5); background-image: url('<?php bloginfo('template_url'); ?>/img/learn-with-us.jpg'); ">
              <div class="text-center rgba-stylish-strong py-5 px-4">
                  <div class="py-5">
                      ...
                      <!--Content-->
                          <h1 id="header-title" style="font-weight:700;font-size:4em;" class="pt-3 mb-5 text-white header-title">
                            <?php 
                            if(is_page( 'Services' )) :
                              echo 'Services</h1> <p style="font-weight:500;font-size:1.5em;" class="px-5 pb-4 text-white">Helpful List of Things</p>';
                            elseif(is_page('Our Team')) :
                                echo 'Our Team</h1> <p style="font-weight:500;font-size:1.5em;" class="px-5 pb-4 text-white">Team Page History</p>';
                            else : 
                              echo 'YoloDigi</h1> <p style="font-weight:500;font-size:1.5em;" class="px-5 pb-4 text-white">Marketing | Optimization | SEO</p>'; 
                            endif ?>
